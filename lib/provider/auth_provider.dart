...
class Auth with ChangeNotifier {
  ...
  Future<void> _authenticate(
    ...
    final url =
        "https://identitytoolkit.googleapis.com/v1/accounts:$urlSegment?key=AIzaSyDx8sdsAQNZn6qA6p4t_WbPRWIuOolAGF0";
    try {
  ...
  Future<String> addUserToDatabase(
    ...
    final url =
        "https://fooddelivery-a27b3.firebaseio.com/users/$userId.json?auth=$authToken";
    try {
