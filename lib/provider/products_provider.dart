...
//    )
  ...
  Future<void> addProduct(Product product) async {
    final url =
        "https://fooddelivery-a27b3.firebaseio.com/products.json?auth=$_authToken";
    try {
      final response = await http.post(url,
          body: json.encode({
            ...
            'preprationTime': product.preprationTime,
  ...
  Future<void> fetchAndSetProducts([bool filterByUser = false]) async {
    ...
    final url =
        "https://fooddelivery-a27b3.firebaseio.com/products.json?auth=$_authToken&$filterString";
    try {
      ...
      final favouriteResponse = await http.get(
          "https://fooddelivery-a27b3.firebaseio.com/userFavourites/$_userId.json?auth=$_authToken");
      ...
      extractedData.forEach((prodId, prodData) {
        loadedProducts.add(Product(
          ...
          preprationTime: double.parse(prodData['preprationTime'].toString(),),
  ...
  Future<void> updateProduct(String id, Product upProduct) async {
    ...
    try {
      if (prodIndex >= 0) {
        final url =
            "https://fooddelivery-a27b3.firebaseio.com/products/$id.json?auth=$_authToken";
        await http.patch(url,
            body: json.encode({
              ...
              'preprationTime': upProduct.preprationTime,
            }));
