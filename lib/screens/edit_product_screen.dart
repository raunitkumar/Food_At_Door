      ...
      try {
        ...
        await showDialog(
            ...
            builder: (ctx) => AlertDialog(
                  ...
                  content:
                      Text("Some error has occurred! Product couldn't be added"),
                  actions: <Widget>[
                    FlatButton(
                      child: Text("OK"),
                      onPressed: () {
    ...
    if (_isInit) {
      ...
      if (productId != null) {
        ...
        initValues = {
          ...
          'preprationTime': _editedProduct.preprationTime.toString(),
                  ...
                  children: <Widget>[
                    TextFormField(
                      ...
                      onSaved: (value) {
                        _editedProduct = Product(
                          ...
                          preprationTime: _editedProduct.preprationTime,
                        );
                      },
                    ),
                    TextFormField(
                      ...
                      validator: (value) {
                        ...
                        if (double.parse(value) <= 0) {
                          return "The price shouldn't be less than zero";
                        }
                        return null;
                      },
                      onSaved: (value) {
                    ...
                    TextFormField(
                      ...
                      validator: (value) {
                        ...
                        if (value.length < 10) {
                          return 'The description must be atleast 15 characters';
                        }
                        return null;
                      },
                      onSaved: (value) {
                     ...
                     TextFormField(
                      initialValue: initValues['preprationTime'],
                      decoration: InputDecoration(labelText: "Prepration Time"),
                      keyboardType: TextInputType.number,
                      textInputAction: TextInputAction.next,
                      ...
                      validator: (value) {
                        ...
                        if (double.tryParse(value) == null) {
                          return 'The time must be in a number format';
                        }
                        if (double.parse(value) <= 0) {
                          return "The time shouldn't be less than zero";
                        }
                        return null;
                      },
                      onSaved: (value) {
                        _editedProduct = Product(
                          ...
                          imageURL: _editedProduct.imageURL,
                          price: _editedProduct.price,
                          preprationTime: double.parse(value),
                        );
                      },
                    ),
                    Row(
